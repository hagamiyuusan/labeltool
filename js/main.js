        ...
        if (selection !== null && selection._objects !== undefined) {
            ...
            boxes.forEach(box => {
                words_object.push({
                    text : box.content,
                    box: [
                        parseFloat(Number(((box.box.aCoords.tl.x * 1000) / (State.image.scaleX * 1000))).toFixed(2)),
                        parseFloat(Number(((box.box.aCoords.tl.y * 1000) / (State.image.scaleY * 1000))).toFixed(2)),
                        parseFloat(Number((((box.box.aCoords.tl.x + box.box.width) * 1000) / (State.image.scaleX * 1000))).toFixed(2)),
                        parseFloat(Number((((box.box.aCoords.tl.y + box.box.height) * 1000) / (State.image.scaleY * 1000))).toFixed(2))
